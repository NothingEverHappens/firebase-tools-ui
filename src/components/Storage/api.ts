...
// import { AddStorageUserPayload, StorageUser } from './types';
//
// const importUser = (user: StorageUser & ApiStorageUserFields) => {
...
// };
//
// export interface ApiStorageUserFields {
//   passwordHash: string;
// }
//
// export default class StorageApi extends RestApi {
...
//   }
//
//   async fetchUsers(): Promise<StorageUser[]> {
...
//   }
//
//   async fetchUser(localId: string): Promise<StorageUser> {
//     const { json } = await this.jsonRequest(
...
//   }
//
//   async createUser(user: AddStorageUserPayload): Promise<StorageUser> {
//     const { json } = await this.jsonRequest(
...
//   }
//
//   async getConfig(): Promise<StorageUser> {
//     const { signIn } = await (
...
//   }
//
//   async updateUser(user: AddStorageUserPayload): Promise<StorageUser> {
//     const { json } = await this.jsonRequest(
...
//   }
//
//   async deleteUser(user: StorageUser): Promise<void> {
